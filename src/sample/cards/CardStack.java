...
// Interfaces have limitations in terms of functionality
// For this I am creating a CardStack without using CardSource
// Deck will have a composition of CardStack instead of implementing CardSource
public class CardStack implements Iterable<Card> {
    ...
    {
        // initialize the attributes by calling default constructor
        this();
